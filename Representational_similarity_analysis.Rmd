...
首先，我们将会读取我们想要预测的神经模式一致性的预估结果。这个数据由上图所示的体素当中，经过 z 分数化的激活模式数据之间的向量化相关矩阵组成。
```{r}
# load neural data
...
我们接下来则会载入一系列特征数据，是单个被试对名人进行的评分：
